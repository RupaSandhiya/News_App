...
class ShowCateogory extends StatelessWidget {
  String Image , desc , title, url;
  ShowCateogory({required this.title,required this.desc,required this.Image,required this.url});
